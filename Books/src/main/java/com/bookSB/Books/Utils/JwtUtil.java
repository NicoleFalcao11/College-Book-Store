package com.bookSB.Books.Utils;
...
public class JwtUtil {
    ...
    public String generateToken(String username , Long rollno , String name) {
        Map<String, Object> claims = new HashMap<>();
        return createToken(claims, username , rollno , name);
    }
    ...
    private String createToken(Map<String, Object> claims, String userName ,Long rollno , String name ) {
        ...
        return Jwts
                ...
                .setSubject(userName)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 24 * 60 * 60 * 1000 )) //+ 24 * 60 * 60 * 1000   //+ 5 * 60 * 1000
                .signWith(getSignKey(), SignatureAlgorithm.HS256).compact();
    }

    private Key getSignKey() {
        byte[] keyBytes = Decoders.BASE64.decode(SECRET);
        return Keys.hmacShaKeyFor(keyBytes); //HMAC (Hash-based Message Authentication Code)
    }
